...
let MerchantController = class MerchantController {
    ...
    addTransaction(merchantId, customerId, description, amount) {
        return this.merchantService.addTransaction(merchantId, customerId, description, amount);
    }
};
__decorate([
    common_1.Get(),
...
__decorate([
    common_1.Post(':id'),
    __param(0, common_1.Param('id')),
    __param(1, common_1.Body('customerId')),
    __param(2, common_1.Body('description')),
    __param(3, common_1.Body('amount')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, Number]),
    __metadata("design:returntype", void 0)
], MerchantController.prototype, "addTransaction", null);
MerchantController = __decorate([
    common_1.Controller('merchants'),
    __metadata("design:paramtypes", [merchant_service_1.MerchantsService])
], MerchantController);
